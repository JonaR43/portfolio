...
function TerminalHeader({ visible }: { visible: boolean }) {
    ...
    return (
        <motion.div
            ...
            // FIX: Z-INDEX 5000 (Very High Layer)
        ...
        >
            ...
            <div style={{ fontFamily: '"Share Tech Mono", monospace' }}>
                <div 
                    style={{
                        backgroundColor: 'rgba(26, 27, 30, 0.95)', // Increased opacity slightly to block labels better
            ...
            <group key={section.id}>
                ...
                <Billboard position={labelPos}>
                    <Html 
                        transform 
                        distanceFactor={4} 
                        // FIX: Z-Index Range is now extremely low [10, 0]
                        // Since HUD is 5000, labels are mathematically forced underneath.
                        zIndexRange={[10, 0]} 
...
export default function GlobeLanding() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', background: COLORS.background, position: 'relative' }}>
        ...
        {/* DOM ORDER SWAP: Canvas First, HUD Second.
            This naturally paints the HUD on top of the Canvas. */}
        ...
        {/* HUD is now AFTER the Canvas in the DOM, guaranteeing it renders on top */}
